...
window.IGCParser = require('igc-parser');

},{"igc-parser":4}],2:[function(require,module,exports){
...
var RE_CCL_HEADER = /^H[FOPS]CCL(?:.{0,}?:(.*)|(.*))$/;
...
},{"flight-recorder-manufacturers/lookup":2}]},{},[1]);
